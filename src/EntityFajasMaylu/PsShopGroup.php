...
use App\Repository\PsShopGroupFajasMayluRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PsShopGroupFajasMayluRepository::class)]
#[ORM\Table(name: "ps_shop_group", schema: 'fajasmaylu_ps')]
class PsShopGroup
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
