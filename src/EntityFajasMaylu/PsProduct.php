...
use App\RepositoryFajasMaylu\PsProductFajasMayluRepository;
...
#[ORM\Entity(repositoryClass: PsProductFajasMayluRepository::class)]
#[ORM\Table(name: "ps_product", schema: 'fajasmaylu_ps')]
class PsProduct
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
