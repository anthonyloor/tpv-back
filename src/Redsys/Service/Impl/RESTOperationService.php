<?php
namespace App\Redsys\Service\Impl;
use App\Redsys\Service\RESTService;
use App\Redsys\Constants\RESTConstants;
use App\Redsys\Utils\RESTSignatureUtils;
use App\Redsys\Utils\RESTLogger;
use App\Redsys\Model\message\RESTResponseMessage;
use App\Redsys\Model\message\RESTInitialRequestMessage;
...
if (!class_exists('RESTOperationService')) {
	...
	class RESTOperationService extends RESTService
	{
		...
		public function createRequestMessage($message)
		{
			...
			$req->setDatosEntrada(json_encode($message));
			//var_dump($req->getDatosEntradaB64());
