...
use App\Redsys\Model\element\RESTOperationElement;
use ReflectionClass;
...
if (! class_exists ( 'RESTService' )) {
	...
	abstract class RESTService {
		...
		protected function checkSignature($sentData, $remoteSignature) {				
			$calcSignature = RESTSignatureUtils::createMerchantSignatureResponse ( $this->getSignatureKey(), $sentData );
