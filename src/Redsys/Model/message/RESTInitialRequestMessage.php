...
namespace App\Redsys\Model\message;

use App\Redsys\Constants\RESTConstants;
use App\Redsys\Model\RESTGenericXml;
use App\Redsys\Model\message\RESTResponseMessage;



if (! class_exists ( 'RESTInitialRequestMessage' )) {
	// include_once $GLOBALS["REDSYS_API_PATH"] . "/Model/RESTGenericXml.php";
	// include_once $GLOBALS["REDSYS_API_PATH"] . "/App/Redsys/Model/message/RESTResponseMessage.php";
	...
	class RESTInitialRequestMessage extends RESTGenericXml {
		...
		*/
		...
		/**
		 * @XML_CLASS=App\Redsys\Model\message\RESTOperationMessage
		 */
		...
		*/
		...
		/**
		 * @param string|null $cardNumber The card number to set
		 */
		...
		/**
		 * @return string|null The card expiry date
		 */
		...
		/**
		 * @param string|null $cardExpiryDate The card expiry date to set
		 */
		...
		//cvv2
		/**
		 * @return string|null The CVV2 code
		 */
		...
		/**
		 * @param string|null $cvv2 The CVV2 code to set
		 */
		...
		function __construct() {
			...
			//$this->datosEntrada = new RESTOperationMessage();
		}
		...
		public function setDatosEntrada($datosEntrada) {
			...
			//dump($this->datosEntrada);
			$this->datosEntradaB64 = base64_encode($this->datosEntrada);
			return $this;
		}
