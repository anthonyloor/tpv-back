...
use App\Redsys\Model\RESTRequestInterface;
...
if (! class_exists ( 'RESTOperationMessage' )) {
	...
	class RESTOperationMessage extends RESTGenericXml implements RESTRequestInterface {
		...
		*/
		...
		/**
		 * @return string|null cardExpiryDate
		 */
		...
		/**
		 * @param string|null the cardExpiryDate to set
		 */
		...
		/**
		 * @param string|null the cvv2 to set
		 */
