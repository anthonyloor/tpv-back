...
use App\Redsys\Model\RESTResponseInterface;
...
//
		 ...
		 * @return mixed The COF Transaction ID
		 */	
		 ...
		 * @return string DCC initialRequest Currency
		 */	
		 ...
		 * @return string DCC initialRequest amount
		 */	
