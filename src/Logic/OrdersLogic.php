...
class OrdersLogic
{
    ...
    public function generatePosOrder($id_shop, $license, $id_employee, $total_paid, $total_cash, $total_card, $total_bizum, $id_order, $num_pedido, $identificador_rts, $cash_recived, $cash_returned): LpPosOrders
    {
    ...
    public function getOrderDetailsByOrderId($id_order)
    {
        return $this->entityManagerInterface->getRepository(PsOrderDetail::class)
            ->findByOrderId($id_order);
    }

    public function getOrdersByShop(int $idShop): array
    {
        return $this->entityManagerInterface->getRepository(PsOrders::class)->findOrdersByShop($idShop);
    }

    public function getLastOrdersByCustomer(int $idCustomer, int $limit = 10): array
    {
    ...
    public function getOrderStateById($id_order_state)
    {
        return $this->entityManagerInterface->getRepository(PsOrderState::class)->findById($id_order_state);
    }
}
